...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/content://com.android.chrome.FileProvider/images/screenshot/1712397179884-539657591.jpg" ; // SET LOGO FOR IMAGE 
...
module.exports = {
  ...
  caption : process.env.CAPTION || "©INFXXZ²²¹-ᴍᴅ"),
 
  author : process.env.PACK_AUTHER|| "INFXXZ-MD",
  packname: process.env.PACK_NAME || "♥️",
  botname : process.env.BOT_NAME  || "INFXXZ-ᴍᴅ",
  ownername:process.env.OWNER_NAME|| "It'x INFXXZ",
